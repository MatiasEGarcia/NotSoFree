...
CREATE TABLE `favorites` (
  ...
  KEY `product` (`product`),
  KEY `user` (`user`),
  CONSTRAINT `favorites_ibfk_1` FOREIGN KEY (`product`) REFERENCES `products` (`id_product`),
  CONSTRAINT `favorites_ibfk_2` FOREIGN KEY (`user`) REFERENCES `users` (`id_user`)
...
-- Dump completed on 2022-09-18 11:26:29
